...
abstract class LibraryMemberBase {
    ...
    LibraryMemberBase(int memberId, String name, String email, String phone) {
...
class StudentMember extends LibraryMemberBase {
...
class FacultyMember extends LibraryMemberBase {
...
class ExternalMember extends LibraryMemberBase {
...
public class LibraryMember {
    ...
    public static void main(String[] args) {
        ...
        switch (choice) {
            ...
            case 1:
                StudentMember s =
                    new StudentMember(id, name, email, phone);
                s.generateSummary();
                break;

            case 2:
                FacultyMember f =
                    new FacultyMember(id, name, email, phone);
                f.generateSummary();
                break;

            case 3:
                ExternalMember e =
                    new ExternalMember(id, name, email, phone);
                e.generateSummary();
                break;
